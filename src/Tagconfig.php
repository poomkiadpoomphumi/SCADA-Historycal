...
<body>
  <div class="background-loader" id="loading-p">
    ...
    <h2 class="TAG" id='metertag'><B>CONFIG TAG : <?php echo $_POST['cboTemplate3']; ?></B></h2>
    <div class="table-container" id="loadpage">
        ...
        <a class="btn btn-warning" style="float:left;margin-right:20px;" onclick="AddTagGMDR('<?php echo $_POST['cboTemplate3']; ?>')">
        <i class="fa fa-plus"></i> Add Tag</a>
        <?php
        include './auth/subClass.php';
        $SCADA = new SCADA();        
        /*if($_POST['cboTemplate3'] == '' && isset($_POST['cboTemplate3'])){
          header("Location: ./Index.php?err=et9c");
        }else{*/
