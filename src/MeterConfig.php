...
<body>
  <div class="background-loader" id="loading-p">
    ...
    <h2 class="TAG"><B>METER CONFIG</B></h2>
    <div class="table-container" id="loadpage">
        ...
        <a class="btn btn-warning" style="float:left;margin-right:20px;" onclick="AddMeter()">
        <i class="fa fa-plus"></i> Add Meter</a>
        <?php
        include './auth/subClass.php';
        $SCADA = new SCADA();
        if($SCADA->checkRoles("2,6") == 'error'){
            header("Location: ./Index.php?PermissionError=403");
        }else{
            echo $SCADA->getMeterConfig();
        }
        ?>
    </div>
</body>
