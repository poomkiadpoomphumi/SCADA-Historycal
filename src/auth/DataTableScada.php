...
class DataTableScada
{
    ...
    public static function getTemplate()
    {
        ...
        while ($row = self::CallbackIterator()->fetch_row($sqlORA)) {
            ...
            $table .= "<tr>
                    ...
                    <td>
                        <a class='btn btn-warning' onclick='EditTMP$id()'>
                            <i class='fas fa-edit'></i>
                        </a>
                        <a class='btn btn-danger' onclick=" . '"DeleteTemplate(' . $id . ')"' . ">
    ...
    public static function getTagconfig($Period, $Tagname)
    {
        ...
        while ($row = self::CallbackIterator()->fetch_row($sqlORA)) { 
            ...
            $table .= "<tr>
                    ...
                    <td>" . $monitor_flag . "</td>
                    <td>
                        <a class='btn btn-warning' onclick='EditTMP$n()'>
                            <i class='fas fa-edit'></i>
                        </a>
                        <a class='btn btn-danger' onclick=" . '"DeleteTag(' . "'$tag'" . ',' . "'$Tagname'" . ',' . "'$ref'" . ')"' . ">
                            <i class='fas fa-trash-alt'></i>
                        </a>
                    </td>
                </tr>";
    ...
    public static function getMeterConfig()
    {
        ...
        while ($row = self::CallbackIterator()->fetch_row($sqlORA)) {
            ...
            $table .= "<tr>
                    ...
                    <td>" . $checkTimeRTU . "</td>
                    <td>
                        <a class='btn btn-warning' onclick='EditMeter$n()'>
                            <i class='fas fa-edit'></i>
                        </a>
                        <a class='btn btn-danger' onclick=" . '"DeleteMeter(' . "'$fc_name'" . ')"' . ">
                            <i class='fas fa-trash-alt'></i>
                        </a>
                    </td>
                </tr>";
    ...
    public static function getUser($groupID)
    {
        ...
        while ($row = self::CallbackIterator()->fetch_row($sqlORA)) {
            ...
            <td>" . $Group . "</td>
            <td>
                <a class='btn btn-warning' onclick='EditUsers$n()'>
                    <i class='fas fa-edit'></i>
                </a>
                <a class='btn btn-danger' onclick=" . '"DeleteUsers(' . "'$user'" . ',' . "'$Group'" . ')"' . ">
                    <i class='fas fa-trash-alt'></i>
                </a>
            </td>
        </tr>";
    ...
    public static function GetTagRTU($RTU,$sh_tag){
        ...
        <a class='btn btn-danger' style='float:right;margin:-42px 80px 0px 0px;' onclick='CancleAddTag()'>Cancle</a>
        <a class='btn btn-primary' style='float:right;margin:-42px 20px 0px 0px;' onclick='SubmitAddTag()'>Add</a>";
        return $table;
    }
};
?>